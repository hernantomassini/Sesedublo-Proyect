...
namespace Sesedublo_SLPL
{
    public partial class Ver_Remito : Form
    {
        ...
        public void meterId(int idFactura, int idCliente)
        {
            ...
            MySqlDataReader reader = Conexion.executeProcedureWithReader("obtenerVendedorDePedido", Conexion.generarArgumentos("_id_factura"), id_factura);

            reader.Read();
            if (reader.HasRows)
            {
                label9.Text = "OBSERVACIONES: " + reader.GetString(0);
            }
        ...
        public void getData()
        {
            ...
            if (reader.HasRows)
            {
                ...
                if (reader.GetString(2) != "") { label8.Text = "TEL.: " + reader.GetString(2).ToUpper(); }
